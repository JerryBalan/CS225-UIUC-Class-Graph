...
OBJS += structures/HSLAPixel.o structures/PNG.o structures/lodepng/lodepng.o
...
$(OBJS_DIR):
	@mkdir -p $(OBJS_DIR)
	@mkdir -p $(OBJS_DIR)/structures
	@mkdir -p $(OBJS_DIR)/structures/catch
	@mkdir -p $(OBJS_DIR)/structures/lodepng
...
CPP_TEST += structures/catch/catchmain.cpp
...
-include $(OBJS_DIR)/*.d
-include $(OBJS_DIR)/structures/*.d
-include $(OBJS_DIR)/structures/catch/*.d
-include $(OBJS_DIR)/structures/lodepng/*.d
